...
const ExperienceLetters = () => {
  ...
  const handleEmployeeSelect = (e) => {
    ...
    if (emp) {
      setFormData({
        ...formData,
        employee_id: emp.employee_id || emp.user_id, // ensure correct ID mapping based on your backend
  ...
  const handleGenerateSubmit = async (e) => {
    ...
    try {
      ...
      const pdfData = {
        ...
        customNote: formData.custom_note,
        refNumber: "EXP-DRAFT" // actual ref generated by backend
      };
      ...
      fData.append('pdf', pdfBlob, 'experience.pdf');
    ...
    <div style={{ padding: "30px", background: "#f8fafc", minHeight: "100vh" }}>
      ...
      <div style={{ background: "white", borderRadius: "12px", boxShadow: "0 4px 6px rgba(0,0,0,0.05)", overflow: "hidden" }}>
        <table style={{ width: "100%", borderCollapse: "collapse", textAlign: "left" }}>
          ...
          <tbody>
            {isLoading ? (
              <tr><td colSpan="5" style={{ textAlign: "center", padding: "40px", color: "#64748b" }}>Loading...</td></tr>
            ) : letters.length > 0 ? (
              letters.map(req => (
                <tr key={req.id} style={{ borderBottom: "1px solid #f1f5f9" }}>
                  ...
                  <td style={{ padding: "16px", color: "#64748b" }}>{new Date(req.date_of_issue).toLocaleDateString('en-GB')}</td>
              ...
              <tr><td colSpan="5" style={{ textAlign: "center", padding: "40px", color: "#64748b" }}>No letters issued yet.</td></tr>
            )}
          </tbody>
        </table>
      </div>
      ...
      {showGenerateModal && (
        <div style={{ position: "fixed", top: 0, left: 0, right: 0, bottom: 0, background: "rgba(0,0,0,0.5)", display: "flex", justifyContent: "center", alignItems: "center", zIndex: 9999 }}>
          <div style={{ background: "white", padding: "24px", borderRadius: "12px", width: "500px", maxWidth: "90%", maxHeight: "90vh", overflowY: "auto" }}>
            ...
            <form onSubmit={handleGenerateSubmit}>
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px", marginBottom: "16px" }}>
                ...
                <div style={{ gridColumn: "span 2" }}>
                  <label style={{ display: "block", marginBottom: "8px", fontWeight: "bold", fontSize: "14px" }}>Custom Closing Note (Optional)</label>
                  <textarea rows="2" style={{ width: "100%", padding: "8px", borderRadius: "6px", border: "1px solid #cbd5e1" }} value={formData.custom_note} onChange={e => setFormData({...formData, custom_note: e.target.value})}></textarea>
                </div>
              </div>
